...
export default function Admin() {
  ...
  return (
    <div className="min-h-screen bg-mist-black text-kimono-white flex relative overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className={`w-64 bg-black/45 backdrop-blur-md border-r border-white/5 flex flex-col fixed h-full z-50 transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>
        ...
        <nav className="flex-1 py-8 px-4 space-y-1 overflow-y-auto scrollbar-none" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
          {tabs.map((tab) => (
            <button
              key={tab.id}
        ...
        <div className="p-4 bg-lime-accent/5 border-t border-white/5">
          <button 
      ...
      {/* Main Content */}
      <main className="ml-0 md:ml-64 flex-1 p-6 md:p-10 overflow-y-auto w-full">
        {/* Mobile Sidebar Header Toggle */}
        <div className="md:hidden flex items-center justify-between bg-black/40 border-b border-white/5 p-4 -mx-6 -mt-6 mb-6">
          <span className="font-display text-sm tracking-[0.2em] text-lime-accent">ADMIN PANEL</span>
          <button 
        ...
        {activeTab === "dashboard" && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-12">
            ...
            <div>
              ...
              <div className="bg-white/5 border border-white/10 overflow-x-auto scrollbar-none" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
